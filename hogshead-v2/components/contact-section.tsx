...
export function ContactSection() {
  return (
    <section id="contact" className="relative overflow-hidden bg-[#041f25] py-28 text-white scroll-mt-28">
      ...
      <Shell className="relative z-10 grid gap-10 lg:grid-cols-[0.86fr_1fr] lg:items-center">
        <Reveal>
          ...
          <a href="mailto:contact@hogshead-tequila.com" className="mt-8 inline-flex items-center gap-3 rounded-full bg-white/10 px-5 py-3 text-[15px] font-extrabold text-white shadow-[inset_0_1px_0_rgba(255,255,255,.10)] backdrop-blur-xl transition hover:bg-white hover:text-deep">
